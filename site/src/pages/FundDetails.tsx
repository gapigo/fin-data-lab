        ...
        <div className="bg-[var(--bg-primary)] min-h-screen">
            <div className="p-6 space-y-8">
                <div className="space-y-2">
                    ...
                    <Skeleton className="h-8 w-1/2 bg-[var(--bg-elevated)]" />
                    <div className="flex gap-2">
                        <Skeleton className="h-6 w-24 bg-[var(--bg-elevated)]" />
                        <Skeleton className="h-6 w-24 bg-[var(--bg-elevated)]" />
                    </div>
                </div>
                <div className="grid grid-cols-1 md:grid-cols-3 xl:grid-cols-6 gap-4">
                    {[1, 2, 3, 4, 5, 6].map(i => <Skeleton key={i} className="h-24 w-full bg-[var(--bg-elevated)]" />)}
                </div>
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    <Skeleton className="lg:col-span-2 h-[400px] bg-[var(--bg-elevated)]" />
                    <div className="space-y-6">
                        <Skeleton className="h-[200px] bg-[var(--bg-elevated)]" />
                        <Skeleton className="h-[200px] bg-[var(--bg-elevated)]" />
                    </div>
                </div>
                <Skeleton className="h-[300px] w-full bg-[var(--bg-elevated)]" />
                <Skeleton className="h-[300px] w-full bg-[var(--bg-elevated)]" />
            </div>
        </div>
    );
            ...
            <div className="p-6 space-y-8 font-sans animate-in fade-in duration-500 pb-20 text-slate-100">
                ...
                <div className="space-y-2">
                    <div className="flex items-center space-x-2 text-sm text-[var(--text-muted)]">
                        <span className="cursor-pointer hover:text-[var(--text-primary)]" onClick={() => window.location.href = '/'}>Dashboard</span>
                        <span>/</span>
                        <span>Fundos</span>
                        <span>/</span>
                    ...
                    <div className="flex gap-2 text-xs text-[var(--text-muted)]">
                        <Badge variant="secondary" className="font-normal text-[var(--text-secondary)] bg-[var(--bg-elevated)] border border-[var(--border-default)] hover:bg-slate-700">
                            CNPJ: {fund.cnpj_fundo}
                        </Badge>
                        <Badge variant="outline" className={`font-normal ${fund.sit === 'EM FUNCIONAMENTO NORMAL' ? 'text-emerald-400 bg-emerald-950/30 border-emerald-800' : 'text-[var(--text-secondary)]'}`}>
                            {fund.sit}
                        </Badge>
                    </div>
                </div>
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                    ...
                    <div className="lg:col-span-2 space-y-6">
                        <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                            <CardHeader className="flex flex-row items-center justify-between pb-2 border-b border-[var(--border-subtle)]">
                                <CardTitle className="text-lg font-medium text-[var(--text-primary)]">Gráfico de Rentabilidade</CardTitle>
                                <Tabs defaultValue="rentabilidade" className="w-[300px]">
                                    <TabsList className="grid w-full grid-cols-2 bg-[var(--bg-elevated)]">
                                        <TabsTrigger value="rentabilidade" className="data-[state=active]:bg-slate-700 data-[state=active]:text-white text-[var(--text-muted)]">Rentabilidade</TabsTrigger>
                                        <TabsTrigger value="janelas" className="data-[state=active]:bg-slate-700 data-[state=active]:text-white text-[var(--text-muted)]">Janelas Móveis</TabsTrigger>
                                    </TabsList>
                                </Tabs>
                            </CardHeader>
                    ...
                    <div className="space-y-6">
                        <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                            <CardHeader>
                                <CardTitle className="text-base font-medium text-[var(--text-primary)]">Informações do Fundo</CardTitle>
                            </CardHeader>
                ...
                <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                    <CardHeader>
                        <CardTitle className="text-lg font-medium text-[var(--text-primary)]">Rentabilidade Histórica</CardTitle>
                    </CardHeader>
                    <CardContent>
                            ...
                            <Table>
                                <TableHeader>
                                    <TableRow className="bg-slate-900 border-none hover:bg-slate-900">
                                        ...
                                        <TableHead className="text-[var(--text-secondary)] text-center">No ano</TableHead>
                                        <TableHead className="text-[var(--text-secondary)] text-center">Acumulado</TableHead>
                                    </TableRow>
                                </TableHeader>
                                <TableBody>
                                    {metrics && Object.keys(metrics.rentabilidade_mes).sort((a, b) => Number(b) - Number(a)).map(year => (
                                        <TableRow key={year} className="hover:bg-[var(--bg-elevated)]/50 border-[var(--border-subtle)]">
                                            ...
                                            <TableCell className="text-center font-semibold text-xs text-[var(--text-muted)]">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                        <CardHeader>
                            <div className="flex items-center gap-2">
                                <CardTitle className="text-lg font-medium text-[var(--text-primary)]">Consistência</CardTitle>
                                    ...
                                    <Table>
                                        <TableHeader className="bg-slate-900">
                                            <TableRow className="border-none hover:bg-slate-900">
                                                <TableHead className="text-[var(--text-secondary)]">Meses Positivos</TableHead>
                                                <TableHead className="text-[var(--text-secondary)]">Meses Negativos</TableHead>
                                                <TableHead className="text-[var(--text-secondary)]">Maior Retorno</TableHead>
                                                <TableHead className="text-[var(--text-secondary)]">Menor Retorno</TableHead>
                                            </TableRow>
                                        </TableHeader>
                                        <TableBody>
                    ...
                    <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                        <CardHeader>
                            <CardTitle className="text-lg font-medium text-[var(--text-primary)]">Composição da carteira</CardTitle>
                                        ...
                                        {composition.items.map((item, index) => (
                                            <div key={index} className="flex items-center justify-between text-sm">
                                                <div className="flex items-center gap-2">
                                                    ...
                                                    <span className="text-[var(--text-secondary)] truncate max-w-[150px]" title={item.name}>{item.name || 'Outros'}</span>
                                                </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-base font-medium text-[var(--text-primary)]">Cotistas</CardTitle>
                                <div className="text-right">
                                    <div className="text-emerald-500 font-bold text-sm">Atual</div>
                                    <div className="text-[var(--text-primary)] font-semibold">{lastQuota?.nr_cotst?.toLocaleString('pt-BR') || '-'}</div>
                                </div>
                            </div>
                            <p className="text-xs text-slate-500 uppercase">{fund.denom_social}</p>
                        </CardHeader>
                    ...
                    <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-base font-medium text-[var(--text-primary)]">Drawdown</CardTitle>
                                <div className="text-right">
                                    <div className="text-emerald-500 font-bold text-sm">Atual</div>
                    ...
                    <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-base font-medium text-[var(--text-primary)]">Patrimônio</CardTitle>
                                <div className="text-right">
                                    <div className="text-emerald-500 font-bold text-sm">Atual</div>
                                    <div className="text-[var(--text-primary)] font-semibold">{lastQuota?.vl_patrim_liq ? formatCurrency(lastQuota.vl_patrim_liq) : '-'}</div>
                                </div>
                            </div>
                            <p className="text-xs text-slate-500 uppercase">{fund.denom_social}</p>
                        </CardHeader>
                    ...
                    <Card className="border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)]">
                        <CardHeader>
                            <div className="flex items-center justify-between">
                                <CardTitle className="text-base font-medium text-[var(--text-primary)]">Volatilidade (21d)</CardTitle>
                                <div className="text-right">
                                    <div className="text-emerald-500 font-bold text-sm">Atual</div>
                                    <div className="text-[var(--text-primary)] font-semibold">{metrics?.volatilidade_12m !== undefined ? formatPercent(metrics.volatilidade_12m) : '-'}</div>
...
const KpiCard = ({ title, value, icon, className, valueClass }: { title: string, value: string, icon?: React.ReactNode, className?: string, valueClass?: string }) => (
    <Card className={`border-0 shadow-sm ring-1 ring-slate-800 bg-[var(--bg-primary)] ${className}`}>
...
const InfoRow = ({ label, value }: { label: string, value: string }) => (
    <div className="flex flex-col border-b border-[var(--border-subtle)] pb-2 last:border-0 last:pb-0">
        <span className="text-xs text-slate-500">{label}</span>
        <span className="text-[var(--text-secondary)] font-medium truncate" title={value}>{value}</span>
    </div>
);
